...
function App() {
  ...
  //dark mode feature
    const [darkmode, setDarkmode] = useState('dark'); // or 'light'
  ...
  return (
    ...
    <div className='grid grid-cols-5 h-screen  text-center'>
      ...
      <div className='col-span-4 p-10'>
        ...
        <div ref={scrollToAns} className='h-[28rem] overflow-y-auto rounded-md p-4 bg-zinc-100 dark:bg-zinc-900 shadow-inner'>
